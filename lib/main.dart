...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
     // Initialize the fortune to prevent page from
     // showing blank
   _randomFortune();
  }
  String _currentFortune = "";

  int _generateRandomNumber = 0;
  Random randomNumber = Random();

  String getRandomFortune(){
    return  fortunes[_generateRandomNumber];
  }


  void _randomFortune() {
    _generateRandomNumber = randomNumber.nextInt(fortunes.length);
    setState(() {
      _currentFortune = fortunes[_generateRandomNumber];
    });

    assert(((fortunes[_generateRandomNumber]) ==  getRandomFortune()), "Random fortunes don't match");
